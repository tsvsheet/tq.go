// Command tq runs a tq query — a pipeline of relational verbs with tsvsheet
// expressions — over a TSV or .tsvt table, TSV in, TSV out. The command tree
...
import (
	...
	"github.com/tsvsheet/tq.go/internal/cli"
)
